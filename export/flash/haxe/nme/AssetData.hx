...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("Shoot", nme.NME_assets_laser_shoot_wav);
			...
			className.set ("assets/Times New Roman.ttf", nme.NME_assets_times_new_roman_ttf);
			type.set ("assets/Times New Roman.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
...
class NME_assets_laser_shoot_wav extends flash.media.Sound { }
...
class NME_assets_times_new_roman_ttf extends flash.text.Font { }
